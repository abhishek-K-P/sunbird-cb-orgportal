...
@Component({
  selector: 'ws-app-pending-approval-events',
  templateUrl: './pending-approval-events.component.html',
  styleUrls: ['./pending-approval-events.component.scss']
})
export class PendingApprovalEventsComponent implements OnInit, OnDestroy {
