...
@Component({
  selector: 'ws-app-rejected-events',
  templateUrl: './rejected-events.component.html',
  styleUrls: ['./rejected-events.component.scss']
})
export class RejectedEventsComponent implements OnInit, OnDestroy {
